...
const sausagePizza = createMenuItem("Sausage Pizza",11,"Pizza");
console.log(sausagePizza);
const pepperoniPizza = createMenuItem("Pepperoni Pizza",10,"Pizza");
console.log(pepperoniPizza);
const anchovyPizza = createMenuItem("Anchovy Pizza",12,"Pizza");
